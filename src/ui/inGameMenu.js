...
export function initInGameMenu({
  ...
  titleBox.innerHTML = `
    <div style="font-size: 18px; font-weight: 900; letter-spacing: 0.08em; display: flex; align-items: baseline; gap: 8px;">
      ...
      <span style="font-size: 10px; font-weight: 800; color: #00e5ff; background: rgba(0, 229, 255, 0.12); border: 1px solid rgba(0, 229, 255, 0.35); padding: 2px 6px; border-radius: 4px; margin-left: 2px;">v0.2.4</span>
    </div>
